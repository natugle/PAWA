...
uses
   {$ifdef fpc} LMessages, LCLIntf, LCLType {$else} messages {$endif}, SysUtils, Classes, Graphics, Controls, Forms,
   ImgList, ActnList, HSButtons, Dialogs;
...
var
   ...
   FlColor, FontColor: TColor;

begin
   if fNew = lcsCustom then exit;

   GetPreDefinedColors(fNew, FlColor, FLightColor, FShadowColor, FColorWhenDown, FHotTrackColor, FontColor, FFlat, bModern, bQuicken);
//   Color := FColor;
